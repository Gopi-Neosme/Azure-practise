    ...
    >
      ...
      <main style={{ position: "relative", zIndex: 10, flex: 1, padding: "24px" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
            <div>
              <h1 style={{ fontSize: "32px", fontWeight: "bold", color: "#fff", marginBottom: "8px" }}>Your Files</h1>
                ...
                {currentMeme.url ? (
                  ...
                  >
                    ...
                    <p style={{ color: "rgba(255, 255, 255, 0.7)", fontSize: "16px" }}>
                      Meme couldn&apos;t load, but here&apos;s a joke:
                      <br />
      ...
      <footer style={{ position: "relative", zIndex: 10, padding: "24px" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", textAlign: "center" }}>
          <p style={{ color: "rgba(255, 255, 255, 0.4)", fontSize: "14px" }}>© 2025 Your App. Made with ❤️</p>
        </div>
      </footer>
